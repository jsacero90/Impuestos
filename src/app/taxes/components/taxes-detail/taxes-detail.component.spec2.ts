...
describe('TaxesDetailComponent', () => {
  let component: TaxesDetailComponent;
  ...
  it('should create TaxesDetailComponent', () => {
    expect(component).toBeTruthy();
  });

  it('should create dowloadFile', () => {
    expect(component.dowloadFile()).toBeTruthy();
  });
});
